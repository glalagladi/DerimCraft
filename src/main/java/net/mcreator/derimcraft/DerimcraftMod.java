 ...
 *
 */
package net.mcreator.derimcraft;
...
@Mod("derimcraft")
public class DerimcraftMod {
	public static final Logger LOGGER = LogManager.getLogger(DerimcraftMod.class);
	public static final String MODID = "derimcraft";
