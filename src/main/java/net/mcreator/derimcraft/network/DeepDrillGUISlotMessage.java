...
public class DeepDrillGUISlotMessage {
	...
	public DeepDrillGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(DeepDrillGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(DeepDrillGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
